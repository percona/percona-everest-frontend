...
export const Messages = {
  ...
  alertText:
    'Database monitoring is currently disabled because no monitoring endpoints have been configured. To enable database monitoring, you should first add a monitoring endpoint.',
