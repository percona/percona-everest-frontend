import { DbEngine, DbEngineStatus, DbEngineToolStatus, DbEngineType } from "../../../types/dbEngines.types";
  ...
  data: [{
    ...
    availableVersions: {
      backup: [{
        version: "2.0.4",
        description: "2.0.4",
        imageHash: "3e351edf305d63fce01c9d4390961c10457fa3b4e42034c26888a2f9131f108d",
    ...
    availableVersions: {
      backup: [{
        ...
        description: "2.4.26",
        imageHash: "3e351edf305d63fce01c9d4390961c10457fa3b4e42034c26888a2f9131f108d",
        imagePath: "percona/percona-xtradb-cluster-operator:1.12.0-pxc5.7-backup",
        status: DbEngineToolStatus.AVAILABLE,
      }, {
        version: "8.0.30",
        description: "8.0.30",
        imageHash: "3e351edf305d63fce01c9d4390961c10457fa3b4e42034c26888a2f9131f108d",
        imagePath: "percona/percona-xtradb-cluster-operator:1.12.0-pxc8.0-backup",
        status: DbEngineToolStatus.RECOMMENDED,
      }],
      engine: [{
        version: '5.7.26-31.37"',
        description: '5.7.26-31.37"',
        imageHash: "9d43d8e435e4aca5c694f726cc736667cb938158635c5f01a0e9412905f1327f",
      ...
      proxy: [{
        version: '2.5.6',
        description: '2.5.6',
        imageHash: "d900211bf5684839cfbaab3ec939ef7bae770638c7d819904820a3882a2aea32",
